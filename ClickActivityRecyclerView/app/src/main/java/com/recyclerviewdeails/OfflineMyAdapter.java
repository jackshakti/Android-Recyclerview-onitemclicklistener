...
public class OfflineMyAdapter extends RecyclerView.Adapter<OfflineMyAdapter.MyViewHolder> {
    private final ArrayList <OfflineItemClass> myList;
    ...
    //--> Constructor
    public OfflineMyAdapter(ArrayList<OfflineItemClass> myList) {
        this.myList = myList;
    }
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.offline_recycler_template,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        OfflineItemClass item = myList.get(position);
